...
TCL_EXTRA_CFLAGS='-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /opt/anaconda1anaconda2anaconda3/include -fdebug-prefix-map=/opt/concourse/worker/volumes/live/10dd1500-e7e9-4eb8-4ab4-a7c774e03737/volume/tk_1592503177392/work=/usr/local/src/conda/tk-8.6.10 -fdebug-prefix-map=/opt/anaconda1anaconda2anaconda3=/usr/local/src/conda-prefix -pipe  -arch x86_64 -D_FORTIFY_SOURCE=2 -mmacosx-version-min=10.9 -isystem /opt/anaconda1anaconda2anaconda3/include '
